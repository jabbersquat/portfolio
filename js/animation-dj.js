...
function clearInlineStyles() {
  ...
  reset
  .set('.title-wrapper, .intro, .section-hdr, .section-hr, .section, .section-content, .section-intro, .site-header, .playlist-wrapper, .site-footer, .section-contact, .site-sidebar-inner button, .playlist-hdr-wrapper', { clearProps: "all" })
  ;
}
