...
function clearInlineStyles() {
  ...
  reset
  .set('#title-wrapper_home, #intro__home, .section-hdr, .section-hr, .section, .section-content, .section-intro, .site-header, .footer, .section-contact, .site-sidebar-inner button', { clearProps: "all" })
  ;
}
